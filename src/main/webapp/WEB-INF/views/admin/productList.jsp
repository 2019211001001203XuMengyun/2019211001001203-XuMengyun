<%@ page import="com.XuMengyun.model.Product" %>
<%@ page import="java.sql.Connection" %>
<%@ page import="com.XuMengyun.model.Category" %>
...
<section id="cart_items">
		...
		<h2 class="title text-center">Product <strong>List</strong></h2> 
               ...
               <c:forEach var="p" items="${productList}">
				   ...
				   <%
					   com.XuMengyun.model.Product p=(com.XuMengyun.model.Product)pageContext.findAttribute("p");
