...
<c:forEach var="o" items="${orderList}">
	...
	<td>${o.orderDate}</td>
						<%
							com.XuMengyun.model.Order o=(com.XuMengyun.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.XuMengyun.dao.UserDao userDao=new com.XuMengyun.dao.UserDao();
	...
	<p>${o.city},${o.state},${o.country}-${o.postalCode}</p><p>${o.phone}</p></td>
						...
						<%
							...
							String paymentType=com.XuMengyun.model.Payment.findByPaymentId(con,n);
							 %>
